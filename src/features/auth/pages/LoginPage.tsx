...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-violet-950 via-indigo-900 to-slate-900 items-center justify-center p-12">
        {/* Orbes de fondo */}
        <div className="absolute top-[-80px] left-[-80px] w-80 h-80 rounded-full bg-violet-600/30 blur-3xl" />
        <div className="absolute bottom-[-60px] right-[-60px] w-96 h-96 rounded-full bg-indigo-500/20 blur-3xl" />
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 mt-2">
              ¿No tienes cuenta?{' '}
              <a href="/register" className="text-violet-400 hover:text-violet-300 font-medium transition-colors duration-200">
                Regístrate gratis
              </a>
            </p>
          </div>
